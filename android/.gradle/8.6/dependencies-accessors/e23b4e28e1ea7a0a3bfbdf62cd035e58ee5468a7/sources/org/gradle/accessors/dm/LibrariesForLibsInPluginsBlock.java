...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class MockitoLibraryAccessors extends SubDependencyFactory {
        ...
        private final MockitoInlineLibraryAccessors laccForMockitoInlineLibraryAccessors = new MockitoInlineLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>mockito.inline</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MockitoInlineLibraryAccessors getInline() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMockitoInlineLibraryAccessors;
        }
    ...
    public static class MockitoCoreLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v3124</b> with <b>org.mockito:mockito-core</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV3124() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("mockito.core.v3124");
        }
     ...
     */
    @Deprecated
    public static class MockitoInlineLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public MockitoInlineLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v3124</b> with <b>org.mockito:mockito-inline</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV3124() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("mockito.inline.v3124");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mockitoCoreVersion</b> with value <b>3.12.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
